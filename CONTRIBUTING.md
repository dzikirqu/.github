...
Report all issues through GitHub Issues using the [Report a Bug](https://github.com/dzikirqu/dzikirqu-android/issues/new?template=bug_report.yaml) template.
...
File your feature request through GitHub Issues using the [Feature Request template](https://github.com/dzikirqu/dzikirqu-android/issues/new?template=feature-request.md).
...
By contributing to DzikirQu, you agree that your contributions will be licensed under its license specified in the repository you are contributing to.